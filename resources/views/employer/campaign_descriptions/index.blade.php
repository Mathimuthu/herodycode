                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <a href="{{ route('employer.questions.create', ['campaign_id' => $description->id]) }}" class="btn btn-sm btn-success ml-1">Create Questions</a>
                                                <a href="{{ route('employer.questions.answers', ['campaign_id' => $description->id]) }}" class="btn btn-sm btn-success ml-1">View Answer</a>
